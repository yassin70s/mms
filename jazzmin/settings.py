...
DEFAULT_SETTINGS: Dict[str, Any] = {
    ...
    "site_icon": "vendor/adminlte/img/o.jpg",
    # Welcome text on the login screen
    "welcome_sign": "الخدمات الطبة العسكرية",
...
DEFAULT_UI_TWEAKS: Dict[str, Any] = {
    ...
    "sidebar_fixed": True,
    # sidemenu colour
    "sidebar": "sidebar-light-olive sidebar-primary sidebar-light-info",
    # sidemenu small text
